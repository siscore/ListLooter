...
elseif clientLocale == "ruRU" then
    ...
    L_OPTIONS_QUESTITEMS =
        "Собирать квестовые предметы";
    L_OPTIONS_AFTERCLOSE = "Закрыть окно добычи";
    L_OPTIONS_FISHLOOT = "Собирать улов";
    L_OPTIONS_LISTPANELNAME = "Список предметов";
    L_OPTIONS_LISTADDTEXT =
        "Для добавления нового предмета введите ItemID:";
    ...
    L_OPTIONS_FRAMEFONTCOUNTSIZE =
        "Размер щрифта количества";
    L_OPTIONS_FRAMEENABLE =
        "Заменить стандартный фрейм сбора";
    L_OPTIONS_USECUSTOMFONT =
        "Использовать сторонний шрифт";
